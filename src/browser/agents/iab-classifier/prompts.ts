 ...
 *
 * TypeScript port of Python prompts module:
 * src/email_parser/workflow/prompts/__init__.py (lines 1-558)
 *
 ...
 * All strings copied character-for-character from Python source.
 */

// ============================================================================
// EVIDENCE GUIDELINES
// Used by agents in prompts AND by Evidence Judge for validation
// Python source: lines 17-121
// ============================================================================
...
/**
 * Purchase Evidence Guidelines
 * Python: lines 100-121
 */
...
// Python source: lines 128-432
// ============================================================================

/**
 * Demographics Agent System Prompt
 * Python: lines 128-180
 */
...
/**
 * Demographics Agent User Prompt
 * Python: lines 182-220
 */
...
/**
 * Household Agent System Prompt
 * Python: lines 222-265
 */
...
/**
 * Household Agent User Prompt
 * Python: lines 267-305
 */
...
/**
 * Interests Agent System Prompt
 * Python: lines 307-345
 */
...
/**
 * Interests Agent User Prompt
 * Python: lines 347-385
 */
...
/**
 * Purchase Agent System Prompt
 * Python: lines 387-432
 */
...
/**
 * Purchase Agent User Prompt
 * Python: lines 434-474
 */
...
// Python source: lines 481-531
// ============================================================================

/**
 * Evidence Judge System Prompt
 * Python: lines 481-531
 */
...
// ============================================================================
// EXPORTS
// Python source: lines 537-558
// ============================================================================

// All 13 constants exported above
