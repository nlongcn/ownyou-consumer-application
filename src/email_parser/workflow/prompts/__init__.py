...
DEMOGRAPHICS_AGENT_SYSTEM_PROMPT = """You are a demographics classification specialist for the IAB Audience Taxonomy.
...
DEMOGRAPHICS_AGENT_USER_PROMPT = """Analyze the user's demographics holistically across ALL emails in the batch.
...
HOUSEHOLD_AGENT_SYSTEM_PROMPT = """You are a household classification specialist for the IAB Audience Taxonomy.
...
HOUSEHOLD_AGENT_USER_PROMPT = """Analyze the user's household characteristics holistically across ALL emails in the batch.
...
INTERESTS_AGENT_SYSTEM_PROMPT = """You are an interests classification specialist for the IAB Audience Taxonomy.
...
INTERESTS_AGENT_USER_PROMPT = """Analyze the user's interests holistically across ALL emails in the batch.
...
PURCHASE_AGENT_SYSTEM_PROMPT = """You are a purchase intent classification specialist for the IAB Audience Taxonomy.
...
PURCHASE_AGENT_USER_PROMPT = """Analyze the user's purchase behavior holistically across ALL emails in the batch.
...
JUDGE_SYSTEM_PROMPT = """You are an evidence quality judge for IAB Taxonomy classifications.
